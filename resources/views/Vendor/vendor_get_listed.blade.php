...
<section class="adip_sec p_120">
    <div class="container">
        <div class="adip_content">
            <div class="hd_text adip_hd">
                <h2 data-aos="zoom-in" data-aos-duration="1000">Lorem ipsum dolor sit amet, cons ectetur adip</h2>
            </div>
        ...
        <div class="our_busn_content" data-aos="zoom-in" data-aos-duration="1000">
            ...
            <div class="row mid_rw">
                ...
                <div class="col-md-4">
                    <div class="our_busn_box">
                        <div class="or_busn_bg">
                            <h4 class="big-bld m-0">2</h4>
                        </div>
                        <div class="our_btm_text">
                            <h6 class="big-bld">Personalize</h6>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusm</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="our_busn_box">
                        <div class="or_busn_bg">
                            <h4 class="big-bld m-0">3</h4>
                        </div>
                        <div class="our_btm_text">
                            <h6 class="big-bld">Manage</h6>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusm</p>
                        </div>
                    </div>
                </div>
