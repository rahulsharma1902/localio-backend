...
<html lang="en">
   ...
   <body>
                                       ...
                                       <div class="notify-cntnt">
                                          ...
                                          <ul class="list-unstyled m-0">
                                             <li>
                                                <a class="d-flex p_lft_rgt" href="">
                                                   <div class="notify-pic">
                                                      <img src="{{asset('user-dashboard-theme/img/notify-img1.png')}}" alt="">
                                                   </div>
                                             ...
                                             <li >
                                                <a class="d-flex p_lft_rgt" href="">
                                                   <div class="notify-pic">
                                                      <img src="{{asset('user-dashboard-theme/img/notify-img2.png')}}" alt="">
                                                   </div>
                                                   <p>Lorem Ipsum is simply dummy text of the printing and
                                                      typesetting industry.
                                                   </p>
                                             ...
                                             <li>
                                                <a class="d-flex p_lft_rgt" href="">
                                                   <div class="notify-pic">
                                                      <img src="{{asset('user-dashboard-theme/img/nootify-img3.png')}}" alt="">
                                                   </div>
                                                   <p>Lorem Ipsum is simply dummy text of the printing and
                                                      typesetting industry.
                                                   </p>
                                             ...
                                             <li>
                                                <a class="d-flex p_lft_rgt" href="">
                                                   <div class="notify-pic">
                                                      <img src="{{asset('user-dashboard-theme/img/notify-img4.png')}}" alt="">
                                                   </div>
                                                   <p>Lorem Ipsum is simply dummy text of the printing and
                                                      typesetting industry.
                                                   </p>
                       ...
                       <li class="nav-links">
                          <a href="{{route('user-product', ['locale' => app()->getLocale()])}}" class="nav-link nav_sv">
                             <div class="side-links">
                                ...
                                <span class="icons-text">Saved Products</span>
                             </div>
                          </a>
                       </li>
                       <li class="nav-links">
                       ...
                       <li class="nav-links">
                          <a href="{{route('user-reward', ['locale' => app()->getLocale()])}}" class="nav-link">
                             <div class="side-links">
                                ...
                                <span class="icons-text">My Rewards</span>
                             </div>
                          </a>
                       </li>
                       <li class="nav-links">
      ...
      <script src="{{asset('user-dashboard-theme/js/script.js')}}"></script>
      <script>
         AOS.init();
      </script>
   </body>
