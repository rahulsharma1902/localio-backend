                                                    ...
                                                    <div class="form-group col-lg-12">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control"
                                                                id="{{ $key }}"
                                                                name="meta_title[{{ $val->id }}]"
                                                                value="{{ $val->meta_value ?? 'not data found' }}" />
                                                        </div>
                                                    </div>

                                                    @elseif($val->meta_key === 'Meta_description')
                                                    <div class="form-group col-lg-12">
                                ...
                                <div class="col-md-12">
                                    <div class="card border">
                                        ...
                                        <div class="card-body">
                                            ...
                                            @endif
                                            @foreach ($allHomeContents as $key => $val)
                                            @if ($val->meta_key == 'meta_user_login_title')
                                                    ...
                                                    <div class="form-group col-lg-12">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control"
                                                                id="{{ $key }}"
                                                                name="meta_user_login_title[{{ $val->id }}]"
                                                                value="{{ $val->meta_value ?? 'not data found' }}" />
                                                        </div>
                                                    </div>

                                                    @elseif($val->meta_key === 'meta_user_login_description')
                                                    <div class="form-group col-lg-12">
                                                        <label class="form-label"
                                                            for="{{ $key }}">Description</label>
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control"
                                                                id="{{ $key }}"
                                                                name="meta_user_login_description[{{ $val->id }}]"
                                                                value="{{ $val->meta_value ?? '' }}" />
                                                        </div>
                                                    </div>
                                                    @endif
                                            ...
                                            @if ($val->meta_key == 'meta_vendor')
                                                    ...
                                                    <div class="form-group col-lg-12">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control"
                                                                id="{{ $key }}"
                                                                name="meta_vendor[{{ $val->id }}]"
                                                                value="{{ $val->meta_value ?? 'not data found' }}" />
                                                        </div>
                                                    </div>

                                                    @elseif($val->meta_key === 'meta_vendor_description')
                                                    <div class="form-group col-lg-12">
                                                        <label class="form-label"
                                                            for="{{ $key }}">Description</label>
                                                        <div class="form-control-wrap">
                                ...
                                <div class="col-md-12">
                                    <div class="card border">
                                        ...
                                        <div class="card-body">
                                            ...
                                            @endif
                                            @foreach ($allHomeContents as $key => $val)
                                            @if ($val->meta_key == 'meta_profile_title')
                                                    ...
                                                    <div class="form-group col-lg-12">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control"
                                                                id="{{ $key }}"
                                                                name="meta_profile_title[{{ $val->id }}]"
                                                                value="{{ $val->meta_value ?? 'not data found' }}" />
                                                        </div>
                                                    </div>

                                                    @elseif($val->meta_key === 'meta_profile_description')
                                                    <div class="form-group col-lg-12">
                                                        <label class="form-label"
                                                            for="{{ $key }}">Description</label>
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control"
                                                                id="{{ $key }}"
                                                                name="meta_profile_description[{{ $val->id }}]"
                                                                value="{{ $val->meta_value ?? '' }}" />
                                                        </div>
                                                    </div>
                                                    @endif
