...
<div class="nk-block nk-block-lg">
    ...
    <?php
        ...
        $footerLogo = \App\Models\FooterContent::where('meta_key' ,'footer_logo')->first();
        $footerFiles = \App\Models\FooterContent::where(function($query) {
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="dz-message">
                                            <input type="file" class="form-control" name="footer_logo[{{$footerLogo->id}}]"
                                                id="metaValue" value="{{ $footerLogo->meta_value ?? ''}}">
                                        </div>
                                        @error('header_logo')
                                        <div class="error text-danger">{{ $message }}</div>
                                        @enderror
                                        @if(!empty($footerLogo->meta_value) &&
                                        file_exists(public_path($footerLogo->meta_value)))
                                        <img src="{{ asset($footerLogo->meta_value) }}" alt="{{ $footerLogo->meta_key }}"
                        ...
                        <div class="card border">
                            ...
                            @foreach($footerContents as $key=>$val)
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="{{ $key }}"
                                            name="discover[{{ $val->id }}]" value="{{ $val->meta_value ?? '' }}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="{{ $key }}"
                                            name="categories[{{ $val->id }}]" value="{{ $val->meta_value ?? '' }}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="{{ $key }}"
                                            name="top_rated_product[{{ $val->id }}]" value="{{ $val->meta_value ?? '' }}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="{{ $key }}"
                                            name="exclusive_deal[{{ $val->id }}]" value="{{ $val->meta_value ?? '' }}" />
                                    </div>
                                </div>
                                @endif
                                @endforeach
                        ...
                        <div class="card border">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="{{ $key }}"
                                            name="company[{{ $val->id }}]" value="{{ $val->meta_value ?? '' }}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="{{ $key }}"
                                            name="who_we_are[{{ $val->id }}]" value="{{ $val->meta_value ?? '' }}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="{{ $key }}"
                                            name="terms_and_conditions[{{ $val->id }}]" value="{{ $val->meta_value ?? '' }}" />
                                    </div>
                                </div>
                                @endif
                                @endforeach
                        ...
                        <div class="card border">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="{{ $key }}"
                                            name="vendors[{{ $val->id }}]" value="{{ $val->meta_value ?? '' }}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="{{ $key }}"
                                            name="get_listed[{{ $val->id }}]" value="{{ $val->meta_value ?? '' }}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="{{ $key }}"
                                            name="vendor_login[{{ $val->id }}]" value="{{ $val->meta_value ?? '' }}" />
                                    </div>
                                </div>
                                @endif
                                @endforeach
                        ...
                        <div class="card border">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="{{ $key }}"
                                            name="help[{{ $val->id }}]" value="{{ $val->meta_value ?? '' }}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="{{ $key }}"
                                            name="expert_guides[{{ $val->id }}]" value="{{ $val->meta_value ?? '' }}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="{{ $key }}"
                                            name="help_center[{{ $val->id }}]" value="{{ $val->meta_value ?? '' }}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="{{ $key }}"
                                            name="contact[{{ $val->id }}]" value="{{ $val->meta_value ?? '' }}" />
                                    </div>
                                </div>
                                @endif
                                @endforeach
                        ...
                        <div class="card border">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="{{ $key }}"
                                            name="follow_us[{{ $val->id }}]" value="{{ $val->meta_value ?? '' }}" />
                                    </div>
                                </div>
                                @endif
                                @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="dz-message">
                                        <input type="file" class="form-control" name="facebook_icon[{{$file->id}}]"
                                            id="metaValue" value="{{ $file->meta_value ?? ''}}">
                                    </div>
                                    @error('facebook_icon')
                                    <div class="error text-danger">{{ $message }}</div>
                                    @enderror
                                    @if(!empty($file->meta_value) &&
                                    file_exists(public_path($file->meta_value)))
                                    <img  class="icon mt-3" src="{{ asset($file->meta_value) }}" alt="{{ $file->meta_key }}"
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="{{ $key }}"
                                            name="facebook_url[{{ $file->id }}]" value="{{ $file->meta_value ?? '' }}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="dz-message">
                                        <input type="file" class="form-control" name="instagram_icon[{{$file->id}}]"
                                            id="metaValue" value="{{ $file->meta_value ?? ''}}">
                                    </div>
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="{{ $key }}"
                                            name="instagram_url[{{ $val->id }}]" value="{{ $file->meta_value ?? '' }}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="dz-message">
                                        <input type="file" class="form-control" name="twitter_icon[{{$file->id}}]"
                                            id="metaValue" value="{{ $file->meta_value ?? ''}}">
                                    </div>
                                    @error('twitter_icon')
                                    <div class="error text-danger">{{ $message }}</div>
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="dz-message">
                                        <input type="text" class="form-control" name="twitter_url[{{$file->id}}]"
                                            id="metaValue" value="{{ $file->meta_value ?? ''}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="{{ $key }}"
                                            name="facebook[{{ $val->id }}]" value="{{ $val->meta_value ?? '' }}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="{{ $key }}"
                                            name="instagram[{{ $val->id }}]" value="{{ $val->meta_value ?? '' }}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="{{ $key }}"
                                            name="twitter[{{ $val->id }}]" value="{{ $val->meta_value ?? '' }}" />
                                    </div>
                                </div>
                                @endif
                                @endforeach
