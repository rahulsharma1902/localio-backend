                        ...
                        <div class="card-inner">
                            ...
                            <div class="col-md-12">
                                ...
                                <select class="form-control" id="status" name="status">
                                    ...
                                    <option value="0" {{ $whoWeAre->status == 0 ? 'selected' : '' }}>Inactive
                                    </option>
                                </select>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#save-mps-button').on('click', function() {
                ...
                let imageFile = $('#update-image-input')[0].files[
            ...
            $('#save-ss-button').on('click', function() {
                ...
                let imageFile1 = $('#update-special-image-input')[0].files[
                    0]; // Get updated image source (base64 or URL)
                let imageFile2 = $('#update-small-image-input')[0].files[
                    0]; // Get updated image source (base64 or URL)
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            $('#update-message').text(response.msg).css('color', 'green')
                                .show();
                    ...
                    error: function(xhr, status, error) {
                        $('#update-message').text('There was an error updating the item.').css(
                            'color', 'red').show();
                    }
                });
