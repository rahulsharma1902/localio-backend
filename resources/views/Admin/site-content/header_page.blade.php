                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="dz-message">
                                                        <input type="file" class="form-control"
                                                            name="header_logo[{{ $headerLogo->id }}]" id="metaValue"
                                    ...
                                    @if ($content->meta_key == 'header_logo')
                                        ...
                                        <div class="card border">
                                            ...
                                            @elseif($content->meta_key === 'login_btn_lable')
                                                <div class="form-group col-lg-12">
                                                    <label class="form-label" for="{{ $key }}">Login Button
                                                        Lable</label>
                                                    <div class="form-control-wrap">
                                            ...
                                            @elseif($content->meta_key === 'sign_up_btn_lable')
                                                <div class="form-group col-lg-12">
                                                    <label class="form-label" for="{{ $key }}">Sign Up Button
                                                        Lable</label>
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control "
                                                            id="{{ $key }}"
                                            ...
                                            @elseif($content->meta_key === 'sign_out_btn_lable')
                                                <div class="form-group col-lg-12">
                                                    <label class="form-label" for="{{ $key }}">Sign Out Button
                                                        Lable</label>
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control "
                                                            id="{{ $key }}"
                                        ...
                                        <div class="card border">
                                            ...
                                            @elseif($content->meta_key === 'categories')
                                                <div class="form-group col-lg-12">
                                                    <label class="form-label" for="{{ $key }}">Categories
                                                        Text</label>
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control "
                                                            id="{{ $key }}"
                                            ...
                                            @elseif($content->meta_key === 'exclusive')
                                                <div class="form-group col-lg-12">
                                                    <label class="form-label" for="{{ $key }}">Exclusive Deal
                                                        Text</label>
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control "
                                                            id="{{ $key }}" name="exclusive[{{ $content->id }}]"
                                                            value="{{ $content->meta_value ?? '' }}" />
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card border">
                                            ...
                                            @elseif($content->meta_key === 'expert_guide')
                                                <div class="form-group col-lg-12">
                                                    <label class="form-label" for="{{ $key }}">Expert Guides
                                                        Text</label>
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control "
                                                            id="{{ $key }}"
                                            ...
                                            @elseif($content->meta_key === 'help_center')
                                                <div class="form-group col-lg-12">
                                                    <label class="form-label" for="{{ $key }}">help Center
                                                        Text</label>
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control "
                                                            id="{{ $key }}"
