                    ...
                    <div class="toggle-expand-content" data-content="pageMenu">
                        <ul class="nk-block-tools g-3">
                            <li class="nk-block-tools-opt">
                                <a href="{{ url('admin-dashboard/review/add') ?? '' }}" class=" btn btn-icon btn-primary d-md-none"><em class="icon ni ni-plus"></em></a>
                                <a href="{{ url('admin-dashboard/review/add') ?? '' }}" class=" btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add Review</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
                                            ...
                                            <div class="drodown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <ul class="link-list-opt no-bdr">
                                                        @if($review->status == 1)
                                                            <li><a href="{{ url('admin-dashboard/review-status-update') ?? '' }}/{{ $review->id ?? ''}}"><em class="icon ni ni-edit-fill"></em><span>Inactive</span></a></li>
                                                        @else
