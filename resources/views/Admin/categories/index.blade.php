...
<div class="nk-block-head nk-block-head-sm">
    ...
    <div class="nk-add-product toggle-slide toggle-slide-right" data-content="addProduct" data-toggle-screen="any" data-toggle-overlay="true" data-toggle-body="true" data-simplebar>
        ...
        <div class="nk-block">
            <form action="{{ url('admin-dashboard/categories/add') ?? '' }}" class="form-validate" novalidate="novalidate" method="post" enctype="multipart/form-data">
            @csrf
                <div class="row g-3">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        <button class="addCategory btn btn-primary form-control text-center"><em class="icon ni ni-plus"></em><span>Add New Category</span></button>
                    </div>
                </div>
            </form>
        </div>
