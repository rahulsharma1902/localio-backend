                        ...
                        <div class="col-md-12 mt-3">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <textarea class="description" name="answer" id="answer" rows="4"
                                        cols="50">{{ strip_tags( isset($faqTranslation) ? $faqTranslation->answer : ($faq->answer) ?? '' ) }}</textarea>
                                </div>
                                @error('answer')
                                <div class="error text-danger">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="col-md-12 mt-4">
                        <div class="form-group">
                            <button class="addCategory btn btn-primary  text-center"><em
                                    class="icon ni ni-plus"></em><span>{{isset($faq) ? 'Update Faq' : 'Add Faq'}}</span></button>
                        </div>
                    </div>
                </form>
            </div>
