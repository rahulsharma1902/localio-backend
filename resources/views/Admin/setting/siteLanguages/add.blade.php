...
<div class="nk-block nk-block-lg">
    ...
    <div class="card card-bordered">
        <div class="card-inner">
            <form action="{{ url('admin-dashboard/site-languages/addProcc') }}" class="form-validate" novalidate="novalidate" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row g-gs">
                    <!-- Name Field -->
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" id="handle" name="handle" value="{{ old('handle') }}" />
                            </div>
                        </div>
                    </div>
