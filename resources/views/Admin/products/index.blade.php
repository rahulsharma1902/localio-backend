                    ...
                    <div class="toggle-expand-content" data-content="pageMenu">
                        <ul class="nk-block-tools g-3">
                            <li class="nk-block-tools-opt">
                                <a href="{{ url('admin-dashboard/product/add') ?? '' }}" class=" btn btn-icon btn-primary d-md-none"><em class="icon ni ni-plus"></em></a>
                                <a href="{{ url('admin-dashboard/product/add') ?? '' }}" class=" btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add Product</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
                                            ...
                                            <div class="drodown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <ul class="link-list-opt no-bdr">
                                                        <li><a href="{{ url('admin-dashboard/product-edit') ?? '' }}/{{ $product->id ?? ''}}"><em class="icon ni ni-edit-fill"></em><span>Edit</span></a></li>
                                                        @if($locale == 'en')
                                                            <li><a href="{{ url('admin-dashboard/remove-product') ?? '' }}/{{ $product->id ?? ''}}"><em class="icon ni ni-trash-fill"></em><span>Remove</span></a></li>
                                                        @endif
                                                    </ul>
                                                </div>
                                            </div>
