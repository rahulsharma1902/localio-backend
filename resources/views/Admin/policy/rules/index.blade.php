                        ...
                        <div class="toggle-expand-content" data-content="pageMenu">
                            <ul class="nk-block-tools g-3">
                                <li class="nk-block-tools-opt">
                                    <a href="{{ url('admin-dashboard/rule/add') ?? '' }}"
                                    ...
                                    <a href="{{ url('admin-dashboard/rule/add') ?? '' }}"
                                        class=" btn btn-primary  btn-localio d-none d-md-inline-flex"><em
                                            class="icon ni ni-plus"></em><span>Add rule</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                                ...
                                                <div class="drodown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end edit-btn"
                                                        ...
                                                        <ul class="link-list-opt no-bdr">
                                                            <li><a
                                                                    href="{{ url('admin-dashboard/rule-edit') ?? '' }}/{{ $rule->id ?? '' }}"><em
                                                                        class="icon ni ni-edit-fill"></em><span>Edit</span></a>
                                                            </li>
                                                            @if ($locale == 'en-us')
                                                                <li><a
                                                                        href="{{ url('admin-dashboard/rule-remove') ?? '' }}/{{ $rule->id ?? '' }}"><em
