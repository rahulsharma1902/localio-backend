        ...
        <div class="container">
            <div class="contact_content" data-aos="fade-up" data-aos-duration="1000">
                ...
                <form class="register_form" action="{{ route('register-process', ['locale'=> getCurrentLocale()]) }}" method="POST" id="registerForm">
                    ...
                    <select name="country_id" class="form-control form-inp-box move-focus mb-4" id="country"
                ...
                form.find('input, select').each(function() {
                    ...
                    // Password field validation
                        ...
                        console.log('Password value:',
                            value); // Check the value of the password input

                        if (value === '') {
                            errorMessage = 'Please enter a password.';
                        } else if (value.length <
                            6) { // Example: password should be at least 6 characters
