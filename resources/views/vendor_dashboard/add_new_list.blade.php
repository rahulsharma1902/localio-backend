...
<div class="col-lg-9 p-0">
    <div class="user_content">
       <div class="new-listing">
        ...
        <div class="new-form">
            <form action="">
                <div class="form-block">
                    <label for="product-name">{{ __('file.Product name') }}</label>
                    <input type="text" id="product-name" name="product-name" placeholder="Add here">
                </div>
                <div class="form-block">
                    <label for="product-category">{{ __('file.Product Category') }}</label>
                    <input type="text" id="product-category" name="product-category" placeholder="Add here">
                </div>
                <div class="form-block">
                    <label for="Website-url">{{ __('file.Website URL') }}</label>
        ...
        <div class="new-btn">
            <a href="javascript:void(0)" class="btn unq_btn">{{ __('file.create listing') }}</a>
        </div>
       </div>
    </div>
</div>
