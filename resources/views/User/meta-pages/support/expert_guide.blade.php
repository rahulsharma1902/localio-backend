               ...
               <div class="banner_row" data-aos="fade-up"  data-aos-duration="1000">
                  <div class="banner_text_col">
                     <div class="banner_content_inner bnr_inr_contnt">
                        <h1>Expert Guides</h1>
                        <p class="expert-p">We have a vast knowledge base with articles, guides, how-to, instructions, and answers to
      ...
      <section class="read_sec_outer expert_sec light p_120">
         <div class="container">
            <div class="hd_text"  data-aos="zoom-in" data-aos-duration="1000">
               <h2>Educational Resources You Can Trust.</h2>
               ...
               <div class="row"   data-aos="fade-up" data-aos-duration="1000">
                  <div class="col-lg-3 col-md-6">
                     <div class="in_cont_box">
                        <div class="read_img">
                           <a href="#" class="blog_thumb"><img class="r_img" src="{{asset('front/img/expt1.png') }}" alt=""></a>
                        </div>
                        <div class="read_content_in">
                           <div class="read_cont_h">
                              <h3 class="read_text"><a href="#">Lorem Ipsum has been the industry's standard
                                 dummy.</a>
                              </h3>
                           </div>
                           <div class="read_para">
                  ...
                  <div class="col-lg-3 col-md-6">
                     <div class="in_cont_box">
                        <div class="read_img">
                           <a href="#" class="blog_thumb"><img class="r_img" src="{{asset('front/img/expt2.png') }}" alt=""></a>
                        </div>
                        <div class="read_content_in">
                           <div class="read_cont_h">
                              <h3 class="read_text"><a href="#">Lorem Ipsum has been</a>
                              </h3>
                           </div>
                           <div class="read_para">
                              <p>
                  ...
                  <div class="col-lg-3 col-md-6">
                     <div class="in_cont_box">
                        <div class="read_img">
                           <a href="#" class="blog_thumb"><img class="r_img" src="{{asset('front/img/expt3.png') }}" alt=""></a>
                        </div>
                        <div class="read_content_in">
                           <div class="read_cont_h">
                              <h3 class="read_text"><a href="#">Lorem Ipsum has been</a>
                  ...
                  <div class="col-lg-3 col-md-6">
                     <div class="in_cont_box">
                        <div class="read_img">
                           <a href="#" class="blog_thumb"><img class="r_img" src="{{asset('front/img/expt4.png' )}}" alt=""></a>
                        </div>
                        <div class="read_content_in">
                           <div class="read_cont_h">
                              <h3 class="read_text"><a href="#">Lorem Ipsum has been</a>
      ...
      <section class="wmail_sec p_120">
         <div class="container">
            <div class="wmail_content">
               <h4 data-aos="zoom-in" data-aos-duration="1000">How To Check Email - Webmail & Email Applications Resources You Can Trust.</h4>
               ...
               <div class="mail_ovr size18" data-aos="fade-up" data-aos-duration="1000">
                  ...
                  <div class="metl-stp size18">
                     <p>Note: For information on configuring your email, please see <a href="#"
                        class="blu_lnk"> Setting Up Email Account: Client Setup SSL/TLS Settings for POP &
                        IMAP. </a>
                     </p>
                  </div>
                  <div class="mail_acknd">
