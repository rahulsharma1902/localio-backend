...
<section class="pvc_sec ">
    <div class="container">
       <div class="pvc_content pvc_mn">
          <h2  data-aos="fade-up" data-aos-duration="1000">Privacy Policy</h2>
          ...
          <div class="pvc_textbx" data-aos="fade-up" data-aos-duration="1000">
             ...
             <div class="pvc_text size18">
                ...
                <p data-aos="fade-up" data-aos-duration="1000"> Dolor in reprehenderit in voluptate velit esse
                   cillum dolore eu fugiat nulla pariatur.
                   Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit
                   anim id est laborum But I must explain to you how all this mistaken idea of denouncing
                ...
                <p">occur in which toil and pain can procure him some great pleasure. To take a trivial example,
                ...
                has no annoying consequences, or one who avoids a pain that produces no resultant</p>
             </div>
          </div>
          <div class="pvc_textbx">
             <h6 data-aos="fade-up" data-aos-duration="1000">How do we use your personal information?</h6>
             <div class="pvc_text size18">
                <p data-aos="fade-up" data-aos-duration="1000">At vero eos et accusamus et iusto odio
                   dignissimos ducimus qui blanditiis praesentium
                   voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati
                   cupiditate non provident, similique sunt in culpa qui officia deserunt:
                </p>
                <div class="pvc_list" data-aos="fade-up" data-aos-duration="1000">
                   <ul>
                      <li>mollitia animi, id est laborum et dolorum</li>
                      <li> fuga. Et harum quidem rerum facilis </li>
                      <li> est et expedita distinctio.</li>
                   </ul>
                </div>
                <p data-aos="fade-up" data-aos-duration="1000">On the other hand, we denounce with righteous
          ...
          <div class="pvc_textbx">
             <h6 data-aos="fade-up" data-aos-duration="1000">Your Rights</h6>
             <div class="pvc_text size18" data-aos="fade-up" data-aos-duration="1000">
          ...
          <div class="pvc_textbx">
             <h6 data-aos="fade-up" data-aos-duration="1000">Embedded content from other websites</h6>
             <div class="pvc_text size18" data-aos="fade-up" data-aos-duration="1000">
          ...
          <div class="pvc_textbx">
             <h6 data-aos="fade-up" data-aos-duration="1000">What rights you have over your data</h6>
             <div class="pvc_text size18">
                <p data-aos="fade-up" data-aos-duration="1000">Lorem ipsum dolor sit amet, consectetur
          ...
          <div class="pvc_textbx">
             <h6 data-aos="fade-up" data-aos-duration="1000">Who we share your data with</h6>
             <div class="pvc_text size18">
                <p data-aos="fade-up" data-aos-duration="1000">Nam libero tempore, cum soluta nobis est eligendi
