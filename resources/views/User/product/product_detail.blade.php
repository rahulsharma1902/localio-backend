            ...
            <div class="col-lg-7">
                ...
                <div class="asana-integration" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <ul class="integrtion-lst">
                        <li><img src="{{asset('front/img/integration-list-img1.svg') }}" alt=""> Adobe Workfront</li>
                        <li><img src="{{asset('front/img/integration-list-img2.svg') }}" alt=""> Confluence</li>
                        <li><img src="{{asset('front/img/integration-list-img3.svg') }}" alt=""> Sage Intacct</li>
                        <li><img src="{{asset('front/img/integration-list-img4.svg') }}" alt="">ThriveCart</li>
                    </ul>
                </div>
                </div>
            </div>
            <div class="col-lg-5">
                ...
                <div class="is-asan-slider">
                    <div class="asan-slider slider-for">
                        <div class="asan-slider-inr"><img src="{{asset('front/img/video-img.png') }}" alt=""></div>
                        <div class="asan-slider-inr"><img src="{{asset('front/img/video-img3.png') }}" alt=""></div>
                        <div class="asan-slider-inr"><img src="{{asset('front/img/video-img.png') }}" alt=""></div>
                        <div class="asan-slider-inr"><img src="{{asset('front/img/video-img3.png') }}" alt=""></div>
                        <div class="asan-slider-inr"><img src="{{asset('front/img/video-img.png') }}" alt=""></div>
                    </div>
                ...
                <div class="sales-crm-pack crm-pack-lft">
                    <div class="inn_sl_hed">
                        <div class="sli_img choice_img">
                            <img class="slider_img" src="{{asset('front/img/big-asana.png') }}" alt="">
                        </div>
                        <div class="sl_h">
