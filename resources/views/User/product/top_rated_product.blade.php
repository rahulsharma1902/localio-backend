          ...
          <div class="banner_row" data-aos="fade-up" data-aos-duration="1000">
             ...
             <div class="banner_image_col">
                <div class="banner_image">
                   <img src="img/top-rated-bnr-bg.png" class="banner_top_image">
                </div>
             </div>
          </div>
       </div>
                ...
                <div class="sharing_icons">
                   <div class="sharing_ul">
                       <a aria-label="Facebook" class="fb_icon" href="" title="Facebook" target="_blank">
                           <span class="svg">
                            <svg style="display:block;border-radius:999px;" focusable="false" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"  width="15px" height="15px"><!--!Font Awesome Free 6.7.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M80 299.3V512H196V299.3h86.5l18-97.8H196V166.9c0-51.7 20.3-71.5 72.7-71.5c16.3 0 29.4 .4 37 1.2V7.9C291.4 4 256.4 0 236.2 0C129.3 0 80 50.5 80 159.4v42.1H14v97.8H80z"/></svg>
                       </a>
                   </div>
                   <div class="sharing_ul">
                   ...
                   <div class="pricing-options">
                      ...
                      <div class="range-wrapper">
                         ...
                         <div class="range-container">
                            ...
                            <input type="range" min="0" max="299" value="299" id="slider-2" oninput="slideTwo()">
                         </div>
                      </div>
                   </div>
                   <div class="pricing-options">
                         ...
                         <div class="auto-choice-hd">
                            <div class="inn_sl_hed">
                               <div class="sli_img choice_img">
                                  <img class="slider_img" src="img/auto-choice1.svg" alt="">
                               </div>
                               <div class="sl_h">
                                  <div class="inn_h">
                                     <div class="sl_main">
                   ...
                   <div class="automotive-card" data-aos="fade-up" data-aos-duration="1000">
                      <div class="auto-choice-card">
                         <div class="auto-choice-hd">
                            <div class="inn_sl_hed">
                               <div class="sli_img choice_img">
                                  <img class="slider_img" src="img/auto-choice2.svg" alt="">
                               </div>
                               <div class="sl_h">
                                  <div class="inn_h">
                                     <div class="sl_main">
                   ...
                   <div class="automotive-card" data-aos="fade-up" data-aos-duration="1000">
                      <div class="auto-choice-card">
                         <div class="auto-choice-hd">
                            <div class="inn_sl_hed">
                               <div class="sli_img choice_img">
                                  <img class="slider_img" src="img/auto-choice3.svg" alt="">
                               </div>
                               <div class="sl_h">
                                  <div class="inn_h">
                                     <div class="sl_main">
                   ...
                   <div class="automotive-card auto-recomend" data-aos="fade-up" data-aos-duration="1000">
                      <div class="auto-choice-card">
                         <div class="auto-choice-hd">
                            <div class="inn_sl_hed">
                               <div class="sli_img choice_img">
                                  <img class="slider_img" src="img/auto-choice4.svg" alt="">
                               </div>
                               <div class="sl_h">
                                  <div class="inn_h">
                                     <div class="sl_main">
                   ...
                   <div class="automotive-card auto-recomend" data-aos="fade-up" data-aos-duration="1000">
                      <div class="auto-choice-card">
                         <div class="auto-choice-hd">
                            <div class="inn_sl_hed">
                               <div class="sli_img choice_img">
                                  <img class="slider_img" src="img/auto-choice5.svg" alt="">
                               </div>
                               <div class="sl_h">
                                  <div class="inn_h">
                                     <div class="sl_main">
 ...
 <section class="subs_sec light p_120 ">
    <div class="container">
       <div class="subs_content">
          ...
          <p data-aos="fade-up" data-aos-duration="1000">By proceeding, you agree to our <span class="big-bld">Terms
