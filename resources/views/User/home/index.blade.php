               ...
               <div class="banner_row" data-aos="fade-up" data-aos-duration="1000">
                  <div class="banner_text_col">
                     <div class="banner_content_inner">
                        ...
                        <p>Get free, unbiased product comparisons, read real customer reviews, and track prices at
                           Localio to score the best offers.
                        </p>
         ...
         <div class="container">
            <div class="trst-brnd-wrp">
               <div class="brnd-wrp-lft">
                  <p class="m-0 brnd-p-txt">Trusted Brands , <br> Unbeatable Choices</p>
               </div>
                                    ...
                                    <div class="row align-items-center">
                                       ...
                                       <div class="col-lg-6 col-md-6">
                                          <div class="accor-txt-contnt">
                                             ...
                                             <div class="accor-btn">
                                                <a href="" class="cta cta_white">Compare Business
                                                Software</a>
                                             </div>
                                          </div>
                                       </div>
                                       ...
                                       <div class="col-lg-4">
                                          <div class="review_card light top-rate-card">
                                             <div class="inner_box_silder  top-rate-innr ">
                                                <div class="inn_sl_hed mst_hdn">
                                                   <div class="sli_img">
                                                      <img class="slider_img" src="{{ asset('front/img/slider1_img.png') ?? '' }}"
                                                         alt="">
                                                   </div>
                                                   <div class="sl_h">
                                                      <div class="inn_h">
                                       ...
                                       <div class="col-lg-4">
                                          <div class="review_card light top-rate-card center-card-pack">
                                             <div class="inner_box_silder  top-rate-innr ">
                                                ...
                                                <div class="inn_sl_hed mst_hdn mt-4">
                                                   <div class="sli_img">
                                                      <img class="slider_img" src="{{ asset('front/img/slider2_img.png') ?? '' }}"
                                                         alt="">
                                                   </div>
                                                   <div class="sl_h">
                                                      <div class="inn_h">
                                       ...
                                       <div class="col-lg-4">
                                          <div class="review_card light top-rate-card">
                                             <div class="inner_box_silder  top-rate-innr ">
                                                <div class="inn_sl_hed mst_hdn">
                                                   <div class="sli_img">
                                                      <img class="slider_img" src="{{ asset('front/img/slider3_img.png') ?? '' }}"
                                                         alt="">
                                                   </div>
                                                   <div class="sl_h">
                                                      <div class="inn_h">
               ...
               <div class="xclusve-slider">
                  <div class="xclusve-pack">
                     ...
                     <div class="xclusve-txt">
                        <a href="" class="">
                           <h6>Hostinger -Scalable hosting solutions for fast websites</h6>
                        </a>
                  ...
                  <div class="xclusve-pack">
                     ...
                     <div class="xclusve-txt">
                        <h6>Namecheap -Budget-friendly hosting plans for every need</h6>
                        <p class="grey-txt"><span class="line-through">$459</span><span
                           class="orange-txt">$367</span>
                        </p>
                        <div class="xclu-txt-btn">
                  ...
                  <div class="xclusve-pack">
                     ...
                     <div class="xclusve-txt">
                        <h6>IONOS -Fast and secure hosting to help your business grow</h6>
                        <p class="grey-txt"><span class="line-through">$459</span><span
                           class="orange-txt">$367</span>
                        </p>
                        <div class="xclu-txt-btn">
               ...
               <div class="smart_search_section dark p_120 pt-0 ">
                  <div class="smart_search_inner">
                     <div class="smart_srch_content text-center size18">
                        ...
                        <p class="smart-p">Quickly discover and compare the best products with our AI-powered
                           search,
                        ...
                        <div class="top-rated-slider" data-aos="fade-up">
                           ...
                           <div class="review_card light top-rate-card">
                              <div class="inner_box_silder  top-rate-innr ">
                                 <div class="inn_sl_hed">
                                    <div class="sli_img">
                                       <img class="slider_img" src="{{ asset('front/img/top-rate-img1.png') ?? '' }}" alt="">
                                    </div>
                                    <div class="sl_h">
                                       <div class="inn_h">
                                          <h6 class="head">Asana</h6>
