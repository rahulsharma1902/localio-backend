    ...
    public function run()
    {
        ...
        DB::table('home_contents')->insert([
            ...
            [
                ...
                'meta_value' => 'my_aacount_description',
                'lang_id' => '1',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            ...
            [
                ...
                'meta_value' => 'saved_product_description',
                'lang_id' => '1',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            ...
            [
                ...
                'meta_value' => 'my_profile_description',
                'lang_id' => '1',
                'created_at' => now(),
                'updated_at' => now(),
            ],
