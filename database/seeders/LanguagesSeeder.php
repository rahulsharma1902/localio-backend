...
class LanguagesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $languages = [
            ...
            ['id' => 3, 'name' => 'Brasil - Português', 'lang_code' => 'pt-br'],
            ['id' => 4, 'name' => 'Canada - English', 'lang_code' => 'en-ca'],
            ['id' => 5, 'name' => 'Canada - Français', 'lang_code' => 'fr-ca'],
            ['id' => 6, 'name' => 'Chile - Español', 'lang_code' => 'es-cl'],
            ['id' => 7, 'name' => 'Colombia - Español', 'lang_code' => 'es-co'],
            ['id' => 8, 'name' => 'Deutschland - Deutsch', 'lang_code' => 'de-de'],
            ['id' => 9, 'name' => 'España - Español', 'lang_code' => 'es-es'],
            ['id' => 10, 'name' => 'Estados Unidos - Español', 'lang_code' => 'es-us'],
            ['id' => 11, 'name' => 'France - Français', 'lang_code' => 'fr-fr'],
            ['id' => 12, 'name' => 'Hong Kong - English', 'lang_code' => 'en-hk'],
            ['id' => 13, 'name' => 'India - English', 'lang_code' => 'en-in'],
            ['id' => 14, 'name' => 'Ireland - English', 'lang_code' => 'en-ie'],
            ['id' => 15, 'name' => 'Israel - English', 'lang_code' => 'en-il'],
            ['id' => 16, 'name' => 'Svizzera - Italiano', 'lang_code' => 'it-ch'],
            ['id' => 17, 'name' => 'Malaysia - English', 'lang_code' => 'en-my'],
            ['id' => 18, 'name' => 'México - Español', 'lang_code' => 'es-mx'],
            ['id' => 19, 'name' => 'New Zealand - English', 'lang_code' => 'en-nz'],
            ['id' => 20, 'name' => 'Österreich - Deutsch', 'lang_code' => 'de-at'],
            ['id' => 21, 'name' => 'Pakistan - English', 'lang_code' => 'en-pk'],
            ['id' => 22, 'name' => 'Perú - Español', 'lang_code' => 'es-pe'],
            ['id' => 23, 'name' => 'Philippines - English', 'lang_code' => 'en-ph'],
            ['id' => 24, 'name' => 'Polska - Polski', 'lang_code' => 'pl-pl'],
            ['id' => 25, 'name' => 'Portuguese - Portugal', 'lang_code' => 'pt-pt'],
            ['id' => 26, 'name' => 'Schweiz - Deutsch', 'lang_code' => 'de-ch'],
            ['id' => 27, 'name' => 'Singapore - English', 'lang_code' => 'en-sg'],
            ['id' => 28, 'name' => 'South Africa - English', 'lang_code' => 'en-za'],
            ['id' => 29, 'name' => 'Suisse - Français', 'lang_code' => 'fr-ch'],
            ['id' => 30, 'name' => 'Türkiye - Türkçe', 'lang_code' => 'tr-tr'],
            ['id' => 31, 'name' => 'United Arab Emirates - English', 'lang_code' => 'en-ae'],
            ['id' => 32, 'name' => 'United Kingdom - English', 'lang_code' => 'en-uk'],
            ['id' => 33, 'name' => 'United States - English', 'lang_code' => 'en-us'],
            ['id' => 34, 'name' => 'Venezuela - Español', 'lang_code' => 'es-ve'],
        ];
